...
- `analyze_6_ablations.py` — **4-ablation** result analysis (ontology excluded). Outputs: `analysis_4_ablations.txt`, `analysis_4_ablations.json`
- `analyze_ablation_results.py`, `analyze_paper_results.py`, `analyze_experiment_results.py` — Result analysis

### Scripts (.sh)
- `run_paper_6_ablations_10seeds.sh` — 10-seed 4 ablations (base, state, reward, full). Logs: `ray_results/paper_4_ablations_10seeds_*`
- `run_paper_6_ablations.sh` — 5-seed 4 ablations. Logs: `ray_results/paper_4_ablations_*`
- `verify_6_ablations_1seed.sh` — 1-seed 4-ablation verification. Logs: `ray_results/verify_4_ablations_*`
- `run_ontology_5pct_improvement.sh` — 5-seed 4 ablations (same settings, ontology experiments excluded)

### Documentation (.md)
- Paper setup/verification: `paper_revision_6_experiments_IEEE_Access.md`, `VERIFICATION_6_ablations.md`
...
- **Analysis**: `python analyze_6_ablations.py --logdir ray_results/paper_4_ablations_10seeds_<TIMESTAMP>`
